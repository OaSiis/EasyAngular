...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
      ...
      dist: {
        files: {
          src: [
            ...
            '<%= config.dist %>/images/{,*/}*.{gif,jpeg,jpg,png}',
    ...
    usemin: {
      ...
      html: ['<%= config.dist %>/{,*/}*.html', '<%= config.dist %>/templates/**/*.html'],
  ...
  grunt.registerTask('serve', 'start the server and preview your app, --allow-remote for remote access', function (target) {
    ...
    if (target === 'dist') {
      return grunt.task.run(['buildDev', 'connect:dist:keepalive']);
    }
    ...
    grunt.registerTask('bro', 'start the server and preview your app', function (target) {
    grunt.task.run([
      'clean:server',
      'wiredep',
      'concurrent:server',
